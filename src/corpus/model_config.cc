...
ModelConfig::ModelConfig()
    : iterations(0),
      ...
      classes(0),
      randomise(false),
      diagonal_contexts(false),
      vocab_size(0),
      noise_samples(0),
      parser_type(ParserType::arcstandard),
      activation(Activation::linear),
      pyp_model(false),
      labelled_parser(false),
      tag_pos(false),
      predict_pos(false),
      lexicalised(false),
      ...
      restricted_semi_supervised(false),
      ...
      bootstrap(false),
      bootstrap_iter(0),
      max_beam_increment(1),
      num_particles(1),
      generate_samples(0),
      num_tags(1),
      num_features(1),
      num_labels(1),
      num_train_sentences(0),
      distance_range(0),
      stack_ctx_size(0),
      child_ctx_level(0),
      out_ctx_size(0),
...
bool ModelConfig::operator==(const ModelConfig& other) const {
  ...
  return (training_file == other.training_file &&
          ...
          restricted_semi_supervised == other.restricted_semi_supervised &&
