...
ParsedSentence::ParsedSentence() : TaggedSentence(), arcs_(), labels_() {}
...
ParsedSentence::ParsedSentence(Words sent, Words tags, WordsList features,
                               Indices arcs, Words labels, int id)
    : TaggedSentence(sent, tags, features, id), arcs_(arcs), labels_(labels) {}
