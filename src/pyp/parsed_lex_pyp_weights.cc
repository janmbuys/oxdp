...
template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
Real ParsedLexPypWeights<wOrder, tOrder, aOrder>::predict(
    WordId word, Context context) const {
  return predictWord(word, context);
}

template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
Reals ParsedLexPypWeights<wOrder, tOrder, aOrder>::predict(
    Context context) const {
  return predictWord(context);
}

template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
Reals ParsedLexPypWeights<wOrder, tOrder, aOrder>::predictWord(
    Context context) const {
...
template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
Real ParsedLexPypWeights<wOrder, tOrder, aOrder>::predictWord(
    WordId word, Context context) const {
  return -std::log(lex_lm_.prob(word, context.words));
}

template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
Reals ParsedLexPypWeights<wOrder, tOrder, aOrder>::predictWordOverTags(
    WordId word, Context context) const {
...
Real ParsedLexPypWeights<wOrder, tOrder, aOrder>::likelihood() const {
  return wordLikelihood() + ParsedPypWeights<tOrder, aOrder>::tagLikelihood() +
         ParsedPypWeights<tOrder, aOrder>::actionLikelihood();
}
...
template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
void ParsedLexPypWeights<wOrder, tOrder, aOrder>::updateInsert(
...
template <unsigned wOrder, unsigned tOrder, unsigned aOrder>
void ParsedLexPypWeights<wOrder, tOrder, aOrder>::updateRemove(
    const boost::shared_ptr<ParseDataSet>& examples, MT19937& eng) {
